    ...
    <main style={{ maxWidth: 900, margin: '64px auto', padding: 24 }}>
      ...
      <section style={{ marginBottom: '2rem' }}>
        ...
        <ul style={{ marginLeft: '2rem' }}>
          ...
          <li>
            <strong>Security Measures</strong>: AES-256 encryption at rest, TLS 1.2+ in transit,
            RBAC, audit logging
          </li>
          <li>
          ...
          <li>
            <strong>Breach Notification</strong>: Anchorpipe notifies Data Controller within 72
