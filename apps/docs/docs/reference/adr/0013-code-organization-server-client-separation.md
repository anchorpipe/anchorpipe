---
id: code-organization-server-client-separation
sidebar_position: 1
---
...
- [Repository Structure Guide](https://github.com/anchorpipe/anchorpipe/blob/main/anchorpipe_guide_docs/impo/repo-structure-guide.md) - General code organization patterns
